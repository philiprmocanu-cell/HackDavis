...
/** Chest / cardiac symptom SMS → outbound heart-sound estimate call (Twilio Record + DSP, not ConvAI). */
export const MEDICAL_ESCALATION_HEART_RATE_CALL = "heart_rate_call";
...
/** @returns {{ sms_reply: string | null; medical_escalation: "none"|"voice_callback"|"heart_rate_call"; escalation_note?: string }} */
export function parseModelCompletion(raw) {
  ...
  if (obj && typeof obj.medical_escalation === "string") {
    ...
    else if (v === MEDICAL_ESCALATION_HEART_RATE_CALL) medical_escalation = MEDICAL_ESCALATION_HEART_RATE_CALL;
  }
